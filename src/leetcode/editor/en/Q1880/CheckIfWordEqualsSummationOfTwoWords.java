package leetcode.editor.en.Q1880;
...
class Solution {
    public boolean isSumEqual(String firstWord, String secondWord, String targetWord) {
        return getNumber(firstWord).add(getNumber(secondWord)).equals(getNumber(targetWord));
    }

    private BigInteger getNumber(String s) {
...
public class CheckIfWordEqualsSummationOfTwoWords extends Solution {
}