package leetcode.editor.en.Q729;
...
// https://github.com/charcuterie/interval-tree
    ...
    class IntervalTree<T extends Interval> implements Iterable<T> {
        ...
        class Node implements Interval {
             ...
             *
             * @param - the Interval to be contained within this Node
             */
    ...
    private IntervalTree<Impl> books;

    public MyCalendar() {
        books = new IntervalTree<Impl>();
    }

    public boolean book(int start, int end) {
        Impl newbook = new Impl(start, end);
        if (books.overlaps(newbook)) return false;
...
public class MyCalendarI extends MyCalendar {
}