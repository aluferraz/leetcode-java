package leetcode.editor.en.Q706;
...
class MyHashMap {
    ...
    private void overflow(int newSize) {
        Integer[] newMap = new Integer[newSize + 1];
...
public class DesignHashmap extends MyHashMap {
}