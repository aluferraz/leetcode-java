package leetcode.editor.en.Q981;
...
class TimeMap {
    ...
    HashMap<String, TreeMap<Integer, String>> timestore = new HashMap<>();
    ...
    public void set(String key, String value, int timestamp) {
        TreeMap<Integer, String> keyMap = timestore.getOrDefault(key, new TreeMap<>());
        keyMap.put(timestamp, value);
        timestore.put(key, keyMap);
    }

    public String get(String key, int timestamp) {
        TreeMap<Integer, String> keyMap = timestore.getOrDefault(key, new TreeMap<>());
        Integer t = keyMap.floorKey(timestamp);
        if (t == null) return "";
        return keyMap.get(t);
    }
}
...
public class TimeBasedKeyValueStore extends TimeMap {
}