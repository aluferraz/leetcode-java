package leetcode.editor.en.Q944;
...
class Solution {
    public int minDeletionSize(String[] strs) {
        ...
        int deletions = 0;
        for (int i = 0; i < len; i++) {
            if (!isSorted(strs, i)) deletions++;
        }
        return deletions;
    }

    private boolean isSorted(String[] strs, int col) {
...
public class DeleteColumnsToMakeSorted extends Solution {
}