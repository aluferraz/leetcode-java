package leetcode.editor.en.Q734;
...
class Solution {
    public boolean areSentencesSimilar(String[] sentence1, String[] sentence2, List<List<String>> similarPairs) {
        ...
        HashMap<String, HashSet<String>> similar = new HashMap<>();
        ...
        for (int i = 0; i < sentence1.length; i++) {
            ...
            if (!similar.getOrDefault(sentence1[i], new HashSet<>()).contains(sentence2[i])) return false;
        }
        return true;
    }
}
...
public class SentenceSimilarity extends Solution {
}