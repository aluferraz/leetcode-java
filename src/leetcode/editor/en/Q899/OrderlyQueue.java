package leetcode.editor.en.Q899;
...
//
//    private int hash(char s, int idx) {
//        return (((int) s - (int) 'a' + 1) * powMod('z', idx)) % mod;
//    }
//
//    private int powMod(int base, int power) {
//        int n = 1;
...
//        return n;
//    }
public class OrderlyQueue extends Solution {
}