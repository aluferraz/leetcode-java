package leetcode.editor.en.Q232;
...
class MyQueue {
    ...
    public void push(int x) {
        while (!FIFO.isEmpty()) {
            TEMPStorage.push(FIFO.pop());
        }
        FIFO.push(x);
        while (!TEMPStorage.isEmpty()) {
            FIFO.push(TEMPStorage.pop());
        }
    }
...
public class ImplementQueueUsingStacks extends MyQueue {
}